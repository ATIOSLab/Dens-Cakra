...
const SATELLITE_SOURCE_ID = "jaring-satellite-source";
const SATELLITE_LAYER_ID = "jaring-satellite-layer";
const SATELLITE_TILES = "https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}";
const DEFAULT_CENTER: [number, number] = [106.8166, -6.2];
...
function geoJsonBounds(value: GeoJSON.GeoJSON): [[number, number], [number, number]] | null {
...
function geometryCenter(geometry: GeoJSON.Geometry | null): [number, number] | null {
...
function districtCoordinate(district: JaringDistributionDistrict): [number, number] | null {
