    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm">
          Kepala BIN Daerah (Kabinda) menerima STR dari Deputi II, lalu meneruskan STR yang sama ke rantai komando di
          bawahnya dengan penajaman arahan regional.
        </p>
      </div>
                        ...
                        <TableCell className="pr-5">
                          <div className="flex justify-end gap-2">
                            {relatedUuk ? (
                              ...
                              <Button asChild size="sm">
                                <Link
                                  href={`/dashboard/kabinda/direktif-penjabaran-uuk-str/baru?directiveVersionId=${currentVersion?.id ?? directive.id}`}
                                >
                                  Baca & Lanjutkan
                                </Link>
                              </Button>
...
export function UukEditorClient({ ownerUnitId, directives, initialDirectiveVersionId }: UukEditorClientProps) {
  ...
  async function handleForward() {
    ...
    try {
      ...
      router.push(`/dashboard/kabinda/direktif-penjabaran-uuk-str/${created.id}`);
      router.refresh();
    } catch (error) {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm">
          Kepala BIN Daerah (Kabinda) hanya membaca STR dari Deputi II lalu meneruskannya ke OIM dalam rantai komando
          yang sama, tanpa mengubah isi STR.
        </p>
      </div>
      ...
      <Card className="border border-border/70">
        ...
        <CardContent className="space-y-4">
          <Alert className="border-border/70 bg-muted/20">
            ...
            <AlertDescription>
              Setelah STR diterbitkan dari Deputi II, tindakan Kepala BIN Daerah (Kabinda) hanya membaca lalu
              meneruskan. Isi STR tetap sama sampai dipakai OIM sebagai dasar tindak lanjut operasional.
            </AlertDescription>
          </Alert>
  ...
  return (
    <div className="relative mx-auto w-full max-w-[1400px] space-y-4 pb-14">
      ...
      <div className="flex items-start gap-2.5 rounded-[6px] border border-white/[0.06] bg-white/[0.02] p-2.5 text-muted-foreground text-xs leading-normal">
        ...
        <div>
          <span className="font-bold text-[var(--dc-text-primary)]">Isi STR terkunci di level regional.</span> Kepala
          BIN Daerah (Kabinda) tidak melakukan edit atau revisi isi. Halaman ini hanya menjadi bukti bahwa STR sudah
        ...
        <div className="space-y-4 lg:col-span-7">
          ...
          <div className="space-y-2 rounded-[6px] border border-white/[0.08] bg-[var(--dc-card)] p-3 shadow-sm">
            ...
            <ul className="grid gap-1.5 pl-4 text-muted-foreground text-xs leading-relaxed md:grid-cols-3">
              ...
              <li>
                Isi STR terkunci sepenuhnya di level Kepala BIN Daerah (Kabinda) guna menjaga integritas informasi
                operasional asli dalam rantai komando.
              </li>
            </ul>
          </div>
