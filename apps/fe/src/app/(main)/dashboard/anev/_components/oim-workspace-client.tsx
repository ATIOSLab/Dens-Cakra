...
const DEFAULT_PRODUCT_CONTEXT: OimProductContext = {
  ...
  listPath: "/dashboard/anev/produk-intelijen/daftar-produk",
  createPath: "/dashboard/anev/produk-intelijen/buat-produk",
  detailBasePath: "/dashboard/anev/produk-intelijen/daftar-produk",
};
                        ...
                        <TableCell className="pr-6 py-4 text-right">
                          ...
                          >
                            <Link
                              href={
                                approval
                                  ? `/dashboard/anev/pengajuan-persetujuan/${item.id}`
        ...
        <Card key={item.id} size="sm">
          <CardContent className="flex items-center justify-between gap-4">
            ...
            <Button asChild variant="outline">
              <Link href={`/dashboard/anev/verifikasi-neraca-penilaian/${item.id}`}>
