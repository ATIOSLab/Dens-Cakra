...
export type JaringReportSessionDetail = {
  ...
  readStatus?: "SUDAH_DIBACA" | "BELUM_DIBACA";
  isRead?: boolean;
  fieldOfficerReadAt?: string | null;
  isReadByFieldOfficer?: boolean;
  gaswilReadAt?: string | null;
  gaswilReadByName?: string | null;
  gaswilReadByUserProfileId?: string | null;
  gaswilReadStatus?: "SUDAH_DIBACA" | "BELUM_DIBACA";
  korwilReadAt?: string | null;
  korwilReadByName?: string | null;
  korwilReadByUserProfileId?: string | null;
  korwilReadStatus?: "SUDAH_DIBACA" | "BELUM_DIBACA";
