...
export default async function Page({ params }: PageProps) {
  ...
  const detail = await apiServerGet<PersonnelDetail>(`/field-coordinator/personnel/${assignmentId}`);

  return <ExecutivePersonnelDetailClient backHref="/dashboard/field-coordinator/personel-jaring" detail={detail} />;
}
