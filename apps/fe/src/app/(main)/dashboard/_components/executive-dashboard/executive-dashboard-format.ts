const STATUS_LABELS: Record<string, string> = {
  ...
  WAITING_FIELD_OFFICER_VERIFICATION: "Belum Diverifikasi",
  NEEDS_FIELD_OFFICER_REVIEW: "Perlu Ditinjau Petugas Wilayah (Gaswil)",
  VERIFIED_BY_FIELD_OFFICER: "Terverifikasi Petugas Wilayah (Gaswil)",
  METADATA_RECORDED: "Baket Dibuat",
  DRAFT: "Draf",
...
const ACTION_LABELS: Record<string, string> = {
  "JARING_REPORT.VERIFIED": "Laporan Jaring diverifikasi",
  "JARING_REPORT.METADATA.CREATE": "Metadata laporan dilengkapi",
  "JARING_REPORT.METADATA.UPDATE": "Metadata laporan diperbarui",
