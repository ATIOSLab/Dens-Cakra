...
import type { JaringReportSessionDetail, PriorityLevel } from "@/app/(main)/dashboard/field-officer/laporan-jaring/_components/laporan-jaring-types";
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell className="text-center">
                        ...
                        >
                          <Link href={`/dashboard/field-officer/laporan-jaring/${item.id}?from=baket`}>
