...
export const DOMAIN_TERMS = {
  ...
  jaringActiveVerified: "Jaring Aktif Terverifikasi",
  jaringVerifiedInactive: "Terverifikasi tetapi Nonaktif",
  jaringPendingApproval: "Menunggu Persetujuan",
  jaringRejected: "Ditolak",
  jaringUnverified: "Belum Terverifikasi",
  jaringOtherStatus: "Status Lainnya",
  jaringProductive: "Jaring Produktif",
  jaringNotReporting: "Jaring Belum Mengirim Laporan",
  productivityPercent: "Persentase Produktivitas",
  unmappedArea: "Wilayah Belum Terpetakan",
  verifiedKendala: "Kendala Terverifikasi",
  reportingAnomaly: "Anomali Pelaporan",
