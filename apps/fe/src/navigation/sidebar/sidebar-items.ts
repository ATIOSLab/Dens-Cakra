...
export const sidebarItems: NavGroup[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: "Beranda",
        url: "/dashboard/field-officer/BERANDA",
        icon: LayoutDashboard,
      ...
      {
        id: "field-officer-whatsapp",
        title: "WhatsApp",
        url: "/dashboard/field-officer/WHATSAPP",
        icon: MessageSquare,
        roles: FIELD_OFFICER_ROLE,
      },
      {
        id: "field-officer-location",
        title: "Location",
        icon: MapPinned,
        roles: FIELD_OFFICER_ROLE,
        subItems: [
          {
            ...
            title: "Report Map",
            url: "/dashboard/field-officer/REPORT-MAP",
            roles: FIELD_OFFICER_ROLE,
          },
          {
            id: "field-officer-live-location",
            title: "Live Location",
            url: "/dashboard/field-officer/LIVE-LOCATION",
            roles: FIELD_OFFICER_ROLE,
          },
        ],
      },
      {
        id: "field-officer-alert",
        title: "Alert",
        url: "/dashboard/field-officer/ALERT",
        icon: TriangleAlert,
        roles: FIELD_OFFICER_ROLE,
      },
      {
