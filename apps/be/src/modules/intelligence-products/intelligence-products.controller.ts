...
export class IntelligenceProductsController {
  ...
  @Get('product-types')
  @ApiContract({ operationId: 'apiTpl001', contractId: 'API-TPL-001', summary: 'Daftar jenis produk intelijen', roles: ['admin_system', 'operational_intelligence_manager'] })
  async listProductTypes(@Query() query: ProductTypeQuery) {
    return apiResult(await this.service.listProductTypes(query));
  }

  @Post('product-types')
  @ApiContract({ operationId: 'apiTpl002', contractId: 'API-TPL-002', summary: 'Buat jenis produk', roles: ['admin_system', 'operational_intelligence_manager'], successStatus: 201, idempotent: true })
  ...
  @ApiContract({ operationId: 'apiTpl003', contractId: 'API-TPL-003', summary: 'Ubah metadata jenis produk', roles: ['admin_system', 'operational_intelligence_manager'] })
  ...
  @ApiContract({ operationId: 'apiTpl004', contractId: 'API-TPL-004', summary: 'Daftar versi template', roles: ['admin_system', 'operational_intelligence_manager'] })
  ...
  @ApiContract({ operationId: 'apiTpl005', contractId: 'API-TPL-005', summary: 'Buat template version', roles: ['admin_system', 'operational_intelligence_manager'], successStatus: 201, idempotent: true })
  ...
  @ApiContract({ operationId: 'apiTpl006', contractId: 'API-TPL-006', summary: 'Detail template', roles: ['admin_system', 'operational_intelligence_manager'] })
  ...
  @ApiContract({ operationId: 'apiTpl007', contractId: 'API-TPL-007', summary: 'Aktifkan template', roles: ['admin_system', 'operational_intelligence_manager'], idempotent: true })
  ...
  @ApiContract({ operationId: 'apiTpl008', contractId: 'API-TPL-008', summary: 'Validasi payload produk terhadap template', roles: ['operational_intelligence_manager'], idempotent: true })
  ...
  @Get('products')
  @ApiContract({ operationId: 'apiPrd001', contractId: 'API-PRD-001', summary: 'Daftar produk intelijen', roles: ['executive', 'regional_commander', 'operational_intelligence_manager'] })
  ...
  @Post('products')
  @ApiContract({ operationId: 'apiPrd002', contractId: 'API-PRD-002', summary: 'Buat produk dan versi awal', roles: ['operational_intelligence_manager'], successStatus: 201, idempotent: true })
  ...
  @ApiContract({ operationId: 'apiPrd003', contractId: 'API-PRD-003', summary: 'Detail produk current version', roles: ['executive', 'regional_commander', 'operational_intelligence_manager'] })
  ...
  @ApiContract({ operationId: 'apiPrd004', contractId: 'API-PRD-004', summary: 'Riwayat versi produk', roles: ['executive', 'regional_commander', 'operational_intelligence_manager'] })
  ...
  @ApiContract({ operationId: 'apiPrd005', contractId: 'API-PRD-005', summary: 'Buat versi revisi produk', roles: ['operational_intelligence_manager'], successStatus: 201, idempotent: true })
  ...
  @ApiContract({ operationId: 'apiPrd006', contractId: 'API-PRD-006', summary: 'Detail versi produk', roles: ['executive', 'regional_commander', 'operational_intelligence_manager'] })
  ...
  @ApiContract({ operationId: 'apiPrd007', contractId: 'API-PRD-007', summary: 'Edit product version draft', roles: ['operational_intelligence_manager'] })
  ...
  @ApiContract({ operationId: 'apiPrd008', contractId: 'API-PRD-008', summary: 'Ganti source verifications', roles: ['operational_intelligence_manager'], idempotent: true })
  ...
  @ApiContract({ operationId: 'apiPrd009', contractId: 'API-PRD-009', summary: 'Ganti source analyses', roles: ['operational_intelligence_manager'], idempotent: true })
  ...
  @ApiContract({ operationId: 'apiPrd010', contractId: 'API-PRD-010', summary: 'Ganti lampiran', roles: ['operational_intelligence_manager'], idempotent: true })
  ...
  @ApiContract({ operationId: 'apiPrd011', contractId: 'API-PRD-011', summary: 'Validasi kesiapan submit', roles: ['operational_intelligence_manager'], idempotent: true })
  ...
  @ApiContract({ operationId: 'apiPrd012', contractId: 'API-PRD-012', summary: 'Submit ke approval regional', roles: ['operational_intelligence_manager'], idempotent: true })
  ...
  @ApiContract({ operationId: 'apiPrd013', contractId: 'API-PRD-013', summary: 'Traceability produk', roles: ['executive', 'regional_commander', 'operational_intelligence_manager'] })
  ...
  @ApiContract({ operationId: 'apiPrd014', contractId: 'API-PRD-014', summary: 'Timeline produk', roles: ['executive', 'regional_commander', 'operational_intelligence_manager'] })
  ...
  @ApiContract({ operationId: 'apiPrd015', contractId: 'API-PRD-015', summary: 'Arsipkan produk', roles: ['operational_intelligence_manager'], idempotent: true })
  ...
  @Get('approval-inbox')
  @ApiContract({ operationId: 'apiApr001', contractId: 'API-APR-001', summary: 'Inbox approval pengguna', roles: ['executive', 'regional_commander', 'operational_intelligence_manager'] })
  ...
  @ApiContract({ operationId: 'apiApr002', contractId: 'API-APR-002', summary: 'Buat ulang workflow jika belum ada', roles: ['operational_intelligence_manager'], successStatus: 201, idempotent: true })
  ...
  @ApiContract({ operationId: 'apiApr003', contractId: 'API-APR-003', summary: 'Detail workflow approval', roles: ['executive', 'regional_commander', 'operational_intelligence_manager'] })
  ...
  @ApiContract({ operationId: 'apiApr004', contractId: 'API-APR-004', summary: 'Detail approval step', roles: ['executive', 'regional_commander', 'operational_intelligence_manager'] })
  ...
  @ApiContract({ operationId: 'apiApr005', contractId: 'API-APR-005', summary: 'Approve step', roles: ['executive', 'regional_commander'], idempotent: true })
  ...
  @ApiContract({ operationId: 'apiApr006', contractId: 'API-APR-006', summary: 'Kembalikan produk untuk revisi', roles: ['executive', 'regional_commander'], idempotent: true })
  ...
  @ApiContract({ operationId: 'apiApr007', contractId: 'API-APR-007', summary: 'Tolak produk', roles: ['executive', 'regional_commander'], idempotent: true })
  ...
  @ApiContract({ operationId: 'apiApr008', contractId: 'API-APR-008', summary: 'Minta klarifikasi tanpa final decision', roles: ['executive', 'regional_commander'], idempotent: true })
  ...
  @ApiContract({ operationId: 'apiApr009', contractId: 'API-APR-009', summary: 'Batalkan workflow', roles: ['regional_commander'], idempotent: true })
  ...
  @ApiContract({ operationId: 'apiApr010', contractId: 'API-APR-010', summary: 'Timeline approval', roles: ['executive', 'regional_commander', 'operational_intelligence_manager'] })
  ...
  @Get('distributions')
  @ApiContract({ operationId: 'apiDst001', contractId: 'API-DST-001', summary: 'Daftar distribusi', roles: ['executive', 'regional_commander', 'operational_intelligence_manager'] })
  ...
  @ApiContract({ operationId: 'apiDst002', contractId: 'API-DST-002', summary: 'Distribusikan produk ke satu atau banyak target', roles: ['executive', 'regional_commander', 'operational_intelligence_manager'], successStatus: 201, idempotent: true })
  ...
  @ApiContract({ operationId: 'apiDst003', contractId: 'API-DST-003', summary: 'Detail distribusi', roles: ['executive', 'regional_commander', 'operational_intelligence_manager'] })
  ...
  @ApiContract({ operationId: 'apiDst004', contractId: 'API-DST-004', summary: 'Callback delivery berhasil', roles: ['admin_system'], idempotent: true })
  ...
  @ApiContract({ operationId: 'apiDst005', contractId: 'API-DST-005', summary: 'Tandai dibaca penerima', roles: ['executive', 'regional_commander', 'operational_intelligence_manager'], idempotent: true })
  ...
  @ApiContract({ operationId: 'apiDst006', contractId: 'API-DST-006', summary: 'Retry distribusi gagal', roles: ['executive'], idempotent: true })
  ...
  @ApiContract({ operationId: 'apiDst007', contractId: 'API-DST-007', summary: 'Cabut akses distribusi', roles: ['executive'], idempotent: true })
  ...
  @ApiContract({ operationId: 'apiDst008', contractId: 'API-DST-008', summary: 'Ringkasan distribusi produk', roles: ['executive', 'regional_commander', 'operational_intelligence_manager'] })
  ...
  @ApiContract({ operationId: 'apiDash001', contractId: 'API-DASH-001', summary: 'Overview dashboard sesuai role', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator'] })
  ...
  @Get('dashboard/kpis')
  @ApiContract({ operationId: 'apiDash002', contractId: 'API-DASH-002', summary: 'KPI operasional', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator'] })
  ...
  @ApiContract({ operationId: 'apiDash003', contractId: 'API-DASH-003', summary: 'Tren laporan/alert/status', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator'] })
  ...
  @ApiContract({ operationId: 'apiDash004', contractId: 'API-DASH-004', summary: 'Agregasi per wilayah', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator'] })
  ...
  @ApiContract({ operationId: 'apiDash005', contractId: 'API-DASH-005', summary: 'Kinerja tugas', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator'] })
  ...
  @ApiContract({ operationId: 'apiDash006', contractId: 'API-DASH-006', summary: 'Progress direktif', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator'] })
  ...
  @ApiContract({ operationId: 'apiDash007', contractId: 'API-DASH-007', summary: 'Kualitas verification', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator'] })
  ...
  @ApiContract({ operationId: 'apiDash008', contractId: 'API-DASH-008', summary: 'Pipeline produk', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator'] })
  ...
  @ApiContract({ operationId: 'apiDash009', contractId: 'API-DASH-009', summary: 'Briefing dashboard lintas modul', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator'] })
  ...
  @Get('map/reports')
  @ApiContract({ operationId: 'apiMap001', contractId: 'API-MAP-001', summary: 'Marker laporan pada viewport', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator', 'field_officer'] })
  ...
  @Get('map/clusters')
  @ApiContract({ operationId: 'apiMap002', contractId: 'API-MAP-002', summary: 'Cluster laporan', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator', 'field_officer'] })
  ...
  @Get('map/heatmap')
  @ApiContract({ operationId: 'apiMap003', contractId: 'API-MAP-003', summary: 'Heatmap laporan', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator', 'field_officer'] })
  ...
  @ApiContract({ operationId: 'apiMap004', contractId: 'API-MAP-004', summary: 'Summary area terpilih', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator', 'field_officer'] })
  ...
  @Get('map/tasks')
  @ApiContract({ operationId: 'apiMap005', contractId: 'API-MAP-005', summary: 'Marker tugas pada viewport', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator', 'field_officer'] })
  ...
  @Get('map/alerts')
  @ApiContract({ operationId: 'apiMap006', contractId: 'API-MAP-006', summary: 'Marker alert pada viewport', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator', 'field_officer'] })
  ...
  @Get('map/emergencies')
  @ApiContract({ operationId: 'apiMap007', contractId: 'API-MAP-007', summary: 'Marker insiden darurat pada viewport', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator', 'field_officer'] })
  ...
  @ApiContract({ operationId: 'apiEmg001', contractId: 'API-EMG-001', summary: 'Daftar insiden darurat', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator', 'field_officer'] })
  ...
  @ApiContract({ operationId: 'apiEmg002', contractId: 'API-EMG-002', summary: 'Buat laporan cepat', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator', 'field_officer'], successStatus: 201, idempotent: true })
  ...
  @ApiContract({ operationId: 'apiEmg003', contractId: 'API-EMG-003', summary: 'Detail insiden', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator', 'field_officer'] })
  ...
  @ApiContract({ operationId: 'apiEmg004', contractId: 'API-EMG-004', summary: 'Update fakta operasional', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator', 'field_officer'] })
  ...
  @ApiContract({ operationId: 'apiEmg005', contractId: 'API-EMG-005', summary: 'Acknowledge insiden', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator'], idempotent: true })
  ...
  @ApiContract({ operationId: 'apiEmg006', contractId: 'API-EMG-006', summary: 'Verifikasi cepat', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator'], idempotent: true })
  ...
  @ApiContract({ operationId: 'apiEmg007', contractId: 'API-EMG-007', summary: 'Mulai penanganan', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator'], idempotent: true })
  ...
  @ApiContract({ operationId: 'apiEmg008', contractId: 'API-EMG-008', summary: 'Tandai situasi terkendali', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator'], idempotent: true })
  ...
  @ApiContract({ operationId: 'apiEmg009', contractId: 'API-EMG-009', summary: 'Selesaikan insiden', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator'], idempotent: true })
  ...
  @ApiContract({ operationId: 'apiEmg010', contractId: 'API-EMG-010', summary: 'Batalkan false alarm/duplicate', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator'], idempotent: true })
  ...
  @Get('alerts')
  @ApiContract({ operationId: 'apiAlt001', contractId: 'API-ALT-001', summary: 'Daftar alert', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator', 'field_officer'] })
  ...
  @Post('alerts')
  @ApiContract({ operationId: 'apiAlt002', contractId: 'API-ALT-002', summary: 'Buat alert manual/system', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator'], successStatus: 201, idempotent: true })
  ...
  @Get('alerts/:alertId')
  @ApiContract({ operationId: 'apiAlt003', contractId: 'API-ALT-003', summary: 'Detail alert', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator', 'field_officer'] })
  async getAlert(@Param('alertId', ParseUUIDPipe) alertId: string) {
    return apiResult(await this.service.getAlert(alertId));
  }

  @Patch('alerts/:alertId')
  @ApiContract({ operationId: 'apiAlt004', contractId: 'API-ALT-004', summary: 'Edit alert sebelum resolved', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator'] })
  ...
  @ApiContract({ operationId: 'apiAlt005', contractId: 'API-ALT-005', summary: 'Acknowledge alert', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator', 'field_officer'], idempotent: true })
  ...
  @ApiContract({ operationId: 'apiAlt006', contractId: 'API-ALT-006', summary: 'Assign alert', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator'], idempotent: true })
  ...
  @ApiContract({ operationId: 'apiAlt007', contractId: 'API-ALT-007', summary: 'Mulai tindak lanjut alert', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator', 'field_officer'], idempotent: true })
  ...
  @ApiContract({ operationId: 'apiAlt008', contractId: 'API-ALT-008', summary: 'Selesaikan alert', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator', 'field_officer'], idempotent: true })
  ...
  @ApiContract({ operationId: 'apiAlt009', contractId: 'API-ALT-009', summary: 'Batalkan alert', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator', 'field_officer'], idempotent: true })
  ...
  @Get('alerts/summary')
  @ApiContract({ operationId: 'apiAlt010', contractId: 'API-ALT-010', summary: 'Ringkasan alert', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator', 'field_officer'] })
  ...
  @ApiContract({ operationId: 'apiLoc001', contractId: 'API-LOC-001', summary: 'Kirim ping lokasi personel', roles: ['field_coordinator', 'field_officer'], successStatus: 201, idempotent: true })
  ...
  @ApiContract({ operationId: 'apiLoc002', contractId: 'API-LOC-002', summary: 'Lokasi terbaru diri sendiri', roles: ['field_coordinator', 'field_officer'] })
  ...
  @ApiContract({ operationId: 'apiLoc003', contractId: 'API-LOC-003', summary: 'Lokasi terbaru bawahan', roles: ['executive', 'regional_commander', 'operational_intelligence_manager', 'field_coordinator'] })
  ...
  @ApiContract({ operationId: 'apiLoc004', contractId: 'API-LOC-004', summary: 'Riwayat lokasi bawahan', roles: ['regional_commander', 'field_coordinator'] })
