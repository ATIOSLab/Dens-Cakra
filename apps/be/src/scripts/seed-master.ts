...
const jaringOccupationSeeds = [
  ...
  [
    'PEGAWAI_SWASTA',
    'Pegawai Swasta',
    'Pekerja pada perusahaan atau lembaga swasta.',
  ],
  ...
  [
    'TENAGA_KESEHATAN',
    'Tenaga Kesehatan',
    'Dokter, perawat, bidan, apoteker, atau tenaga kesehatan lain.',
  ],
  [
    'MAHASISWA_PELAJAR',
    'Mahasiswa / Pelajar',
    'Peserta pendidikan tinggi atau sekolah.',
  ],
  [
    'BURUH_KARYAWAN',
    'Buruh / Karyawan',
    'Pekerja operasional, produksi, lapangan, atau harian.',
  ],
  ...
  [
    'SOPIR_TRANSPORTASI',
    'Sopir / Transportasi',
    'Pengemudi angkutan umum, logistik, atau kendaraan operasional.',
  ],
  [
    'OJEK_ONLINE_KURIR',
    'Ojek Online / Kurir',
    'Pengemudi ojek online, kurir, atau pekerja layanan antar.',
  ],
  [
    'SATPAM_SECURITY',
    'Satpam / Security',
    'Petugas keamanan lingkungan, gedung, atau perusahaan.',
  ],
  [
    'JURNALIS_MEDIA',
    'Jurnalis / Media',
    'Pekerja media, wartawan, atau pengelola kanal informasi.',
  ],
  [
    'TOKOH_AGAMA',
    'Tokoh Agama',
    'Pemuka agama atau pengurus kegiatan keagamaan.',
  ],
  [
    'TOKOH_MASYARAKAT',
    'Tokoh Masyarakat',
    'Tokoh lokal, pengurus komunitas, atau figur masyarakat.',
  ],
  ...
  [
    'PENSIUNAN',
    'Pensiunan',
    'Purna tugas dari pekerjaan formal atau informal.',
  ],
  [
    'TIDAK_BEKERJA',
    'Tidak Bekerja',
    'Belum atau tidak memiliki pekerjaan aktif.',
  ],
  [
    'LAINNYA',
    'Lainnya',
    'Pekerjaan lain yang belum tersedia pada master data.',
  ],
] as const;
