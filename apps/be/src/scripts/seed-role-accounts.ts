...
const baselineAccounts: readonly SeedAccount[] = [
  ...
  {
    email: 'kasubdit.jaba@denscakra.local',
    name: 'Manajer Intelijen Supervisi DKI',
    password: defaultDemoPassword,
    username: 'oim.supervisi.dki',
    systemRole: SYSTEM_ROLES.OPERATIONAL_INTELLIGENCE_MANAGER,
  ...
  {
    email: 'kabagops.31@denscakra.local',
    name: 'Manajer Intelijen Binda DKI',
    password: defaultDemoPassword,
    username: 'oim.binda.31',
    systemRole: SYSTEM_ROLES.OPERATIONAL_INTELLIGENCE_MANAGER,
    roleCode: RoleCode.OPERATIONAL_INTELLIGENCE_MANAGER,
    branch: CommandRouteType.BINDA,
    scopeGroup: 'DKI_PROVINCE',
